...
import { getVocabularyByid, updateVocabulary } from '../../../../../services/VocabularyServices';
...
const EditVocabularyPage = () => {
    ...
    const handleFileChange = async (event) => {
        ...
        if (response.status === 200) {
            ...
            setVocabulary({ ...vocabulary, vocabulary_audio: createIAudioUrl(response.data.filename) });
        }
    };
    ...
    const handleDeleteAudioSubmit = async () => {
        try {
            ...
            if (deleteResult.success) {
                ...
                setVocabulary({...vocabulary, vocabulary_audio: ''});
            } else {
