                    ...
                    <div className="flex-1 flex flex-col px-1 pt-2 pb-4 overflow-y-auto">
                        <div className="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul className="space-y-2 pb-2">
                                <li className={active === 1 ? "text-base text-white font-normal rounded-lg bg-custom-color-blue flex items-center p-2 group " : "text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group"}>
                                ...
                                <li className={active === 2 ? "text-base text-white font-normal rounded-lg bg-custom-color-blue flex items-center p-2 group " : "text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "}>
                                ...
                                <li className={active === 3 ? "text-base text-white font-normal rounded-lg bg-custom-color-blue flex items-center p-2 group " : "text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "}>
                                ...
                                <li className={active === 4 ? "text-base text-white font-normal rounded-lg bg-custom-color-blue flex items-center p-2 group " : "text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "}>
                                ...
                                <li className={active === 5 ? "text-base text-white font-normal rounded-lg bg-custom-color-blue flex items-center p-2 group " : "text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "}>
                                ...
                                <li className={active === 6 ? "text-base text-white font-normal rounded-lg bg-custom-color-blue flex items-center p-2 group " : "text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "}>
